...
function Navbar() {
  ...
  return (
    <nav className="sticky z-20 h-20 inset-x-0 top-0 px-4 w-full dark:bg-slate-800 bg-white dark:text-white text-black border-b-2 border-orange-500">
      <MaxWidthWrapper>
        ...
        >
          <div className="flex flex-col items-start gap-4 p-4 mt-2">
            {user?.username && (
              <button
                onClick={handleLogout}
                className=" h-9 px-3 py-2 items-center rounded-md flex flex-row justify-between w-full text-orange-500 font-semibold dark:bg-slate-800 bg-white text-2xl dark:hover:bg-slate-700 hover:bg-zinc-200 outline-none cursor-pointer"
              >
                <span>Logout</span>
            ...
            <Link
              href="/explore"
              className="h-9 px-3 py-2 items-center rounded-md flex flex-row justify-between w-full dark:bg-slate-800 bg-white text-2xl dark:hover:bg-slate-700 hover:bg-zinc-200 outline-none cursor-pointer"
            >
              <p className="text-orange-500 font-semibold">Events</p>
